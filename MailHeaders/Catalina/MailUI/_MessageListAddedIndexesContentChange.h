...
// - (void).cxx_destruct;	// IMP=0x00000001001dba1e
@property(readonly, copy) NSString *description;
- (void)incrementChangeIndexesBy:(unsigned long long)arg1;	// IMP=0x00000001001db925
- (unsigned long long)shiftIndex:(unsigned long long)arg1;	// IMP=0x00000001001db837
- (void)applyToTableView:(id)arg1;	// IMP=0x00000001001db7b3
- (id)init;	// IMP=0x00000001001db6e4
- (id)initWithIndexes:(id)arg1 animationOptions:(unsigned long long)arg2;	// IMP=0x00000001001db666
